        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-4 sm:p-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-6">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900">Select Period</h3>
                <p className="text-sm sm:text-base text-gray-600">Choose the time range for your analytics</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="group relative overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="relative p-4 sm:p-6">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Total Inventory</h3>
              <p className="text-xs sm:text-sm text-gray-600">Complete item count in system</p>
          ...
          <div className="group relative overflow-hidden bg-gradient-to-br from-orange-50 to-red-100 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="relative p-4 sm:p-6">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Low Stock Alert</h3>
              <p className="text-xs sm:text-sm text-gray-600">Items requiring attention</p>
          ...
          <div className="group relative overflow-hidden bg-gradient-to-br from-emerald-50 to-green-100 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="relative p-4 sm:p-6">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">Monthly Activity</h3>
              <p className="text-xs sm:text-sm text-gray-600">Total transactions recorded</p>
